package com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.adapters;

import com.hzera.oauth2.spring.main.oauth2.server.application.ports.driver.ExampleServicePort;
import com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.mappers.ExampleDTOMapper;
import com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.openapi.ExamplesApi;
import com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.openapi.model.ExampleRequest;
import com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.openapi.model.ExampleResourceCollectionResponse;
import com.hzera.oauth2.spring.main.oauth2.server.driver.api.rest.v1.openapi.model.ExampleResourceResponse;
